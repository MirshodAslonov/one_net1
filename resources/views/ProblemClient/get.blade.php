...
<div class="container-fluid mt-5">
    <div class="card shadow-lg border-0">
                ...
                <div class="col-md-12 mb-4" style="
                    ...
                    <div style="
                        ...
                        <label class="form-label" style="
                                        ...
                                        display: block;
                                    ">Show</label>
                        <a href="{{ route('getClient', $values['client']['id']) }}" style="
        ...
        " onmouseover="this.style.backgroundColor='#2563eb'"
            ...
            @foreach ($values['problems'] as $problem)
                    <div class="col-md-12 mb-4" style="
                                            display: flex;
                                            flex-direction: column;
                                            gap: 10px;
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div style="display: flex; justify-content: space-between; align-items: center;gap: 20px;">
                                <!-- User Name -->
                                <span class="font-weight-bold" style="font-size: 16px; color: #3b82f6;">
        {{ $problem['user']['name'] ?? 'Unknown User' }}
    </span>

                                <!-- Created At -->
                                <span style="font-size: 14px; color: #6b7280;">
        {{ $problem['created_at'] ?? 'Unknown Date' }}
    </span>
                            </div>
            ...
            <!-- Answer Section -->
                ...
                <div class="col-md-12 mb-4" style="
                                ...
                                border-radius: 12px;
                                padding: 20px 30px;
                                background: linear-gradient(120deg, #ffffff, #fef7e0);
                                box-shadow: 0 6px 12px rgba(0, 0, 0, 0.15);
                            ">
                    <!-- User Info -->
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <span class="font-weight-bold" style="
                            ...
                            color: #f97316;
                        ">
            {{ $values['answer_user']['name'] ?? 'Unknown User' }}
        </span>
                        <span style="font-size: 14px; color: #6b7280;">
        {{ $values['updated_at'] ?? 'Unknown Date' }}
    </span>
                        </div>
                        <span style="
            font-size: 14px;
            ...
            Answer
                ...
                @else
                    <div class="col-md-12" style="padding-bottom: 30px;">
                        ...
                        <!-- Textarea -->
                            <textarea id="problem" name="content" rows="3" class="form-control" style="height: 300px;" placeholder="Enter comment"></textarea>

                            <!-- Buttons -->
                            <div style="display: flex; justify-content: flex-end; margin-top: 10px;">
                                <!-- Problem Button -->
                                <button type="submit" name="type" value="problem" class="btn-update" style="margin-right: 10px;">Problem</button>

                                <!-- Answer Button -->
                                <button type="submit" name="type" value="answer" class="btn-update">Answer</button>
                            </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mb-1">
                        ...
                        <div class="image-upload">
                            ...
                            @if(isset($values['images']['problem_image1']))
                                <img src="http://one_net1.loc{{ $values['images']['problem_image1']['url'] }}" alt="Image 1"
                    ...
                    <div class="col-md-2 mb-1">
                        ...
                        <div class="image-upload">
                            ...
                            @if(isset($values['images']['problem_image2']))
                                <img src="http://one_net1.loc{{ $values['images']['problem_image2']['url'] }}" alt="Image 1"
                                     class="preview-image" style=" width:200px; height:120px; object-fit:cover; margin-top: 7px">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 mb-1">
                        ...
                        <div class="image-upload">
                            ...
                            @if(isset($values['images']['problem_image3']))
                                <img src="http://one_net1.loc{{ $values['images']['problem_image3']['url'] }}" alt="Image 1"
                                     class="preview-image" style=" width:200px; height:120px; object-fit:cover; margin-top: 7px">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 mb-1">
                        ...
                        <div class="image-upload">
                            ...
                            @if(isset($values['images']['problem_image4']))
                                <img src="http://one_net1.loc{{ $values['images']['problem_image4']['url'] }}" alt="Image 1"
                                     class="preview-image" style=" width:200px; height:120px; object-fit:cover; margin-top: 7px">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 mb-1">
                        ...
                        <div class="image-upload">
                            ...
                            @if(isset($values['images']['problem_image5']))
                                <img src="http://one_net1.loc{{ $values['images']['problem_image5']['url'] }}" alt="Image 1"
                                     class="preview-image" style=" width:200px; height:120px; object-fit:cover; margin-top: 7px">
                            @endif
                        </div>
                    </div>
                    <div class="col-md-2 mb-1">
                        ...
                        <div class="image-upload">
                            ...
                            @if(isset($values['images']['problem_image6']))
                                <img src="http://one_net1.loc{{ $values['images']['problem_image6']['url'] }}" alt="Image 1"
                                     class="preview-image" style=" width:200px; height:120px; object-fit:cover; margin-top: 7px">
                            @endif
                        </div>
                    </div>
