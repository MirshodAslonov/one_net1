...
<head>
    ...
    <style>
        ...
        /* Input field styles for danger and success states */
        .is-danger {
            ...
            <form action="{{ route('updateClient', ['id' => $values['id']]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        <label for="branch_id" class="form-label" style="font-weight: bold;">Branch</label>
                        <select id="branch_id" name="branch_id" class="form-select" data-live-search="true" required>
                            ...
                            @foreach ($branches as $branch)
                                <option value="{{ $branch->id }}" {{ old('branch_id', $values['branch_id']) == $branch->id ? 'selected' : '' }}>
                                {{ $branch->name }}
                            @endforeach
                        </select>
                    </div>
                    ...
                    <!-- Organization -->
                    <div class="col-md-3 mb-4">
                        <label for="organ_id" class="form-label" style="font-weight: bold;">Organization</label>
                        <select id="organ_id" name="organ_id" class="form-select" required>
                            ...
                            @foreach ($organs as $organ)
                                <option value="{{ $organ->id }}" {{ old('organ_id', $values['organ_id']) == $organ->id ? 'selected' : '' }}>
                                {{ $organ->name }}
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <label for="name_organ" class="form-label" style="font-weight: bold;">Host Name</label>
                        <input type="text" id="name_organ" name="name_organ" class="form-control" placeholder="Enter host name"
                               value="{{ old('name_organ', $values['name_organ']) }}" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mb-4">
                        ...
                        <div class="d-flex">
                            <input type="text" id="mgmt_ip" name="mgmt_ip" class="form-control" placeholder="0.0.0.0"
                                   value="{{ old('mgmt_ip', $values['mgmt_ip']) }}">
                    ...
                    <!-- IP -->
                    <div class="col-md-2 mb-4">
                        <label for="ip" class="form-label" style="font-weight: bold;">IP Address</label>
                        <input type="text" id="ip" name="ip" class="form-control" placeholder="0.0.0.0/0"
                               value="{{ old('ip', $values['ip']) }}">
                    </div>

                    <!-- VLAN -->
                    <div class="col-md-2 mb-4">
                        <label for="vlan" class="form-label" style="font-weight: bold;">VLAN</label>
                        <input type="number" id="vlan" name="vlan" class="form-control" placeholder="Enter Vlan"
                               value="{{ old('vlan', $values['vlan']) }}">
                    </div>

                    <!-- VLAN 2 IP -->
                    <div class="col-md-2 mb-4">
                        <label for="vlan_ip" class="form-label" style="font-weight: bold;">VLAN 2 IP</label>
                        <input type="text" id="vlan_ip" name="vlan_ip" class="form-control" placeholder="Enter VLAN 2 IP"
                               value="{{ old('vlan_ip', $values['vlan_ip']) }}">
                    </div>

                    <!-- Request -->
                    <div class="col-md-2 mb-4">
                        <label for="zayafka" class="form-label" style="font-weight: bold;">Zayafka</label>
                        <input type="text" id="zayafka" name="zayafka" class="form-control" placeholder="Enter Zayafka"
                               value="{{ old('zayafka', $values['zayafka']) }}" required>
                    </div>

                    <!-- STP Request -->
                    <div class="col-md-2 mb-4">
                        <label for="stp_zayafka" class="form-label" style="font-weight: bold;">STP Zayafka</label>
                        <input type="text" id="stp_zayafka" name="stp_zayafka" class="form-control" placeholder="Enter STP zayafka"
                               value="{{ old('stp_zayafka', $values['stp_zayafka']) }}">
                    </div>
                ...
                <div class="row">
                    <!-- ATC -->
                    <div class="col-md-2 mb-4">
                        <label for="atc" class="form-label" style="font-weight: bold;">ATC</label>
                        <input type="text" id="atc" name="atc" class="form-control" placeholder="Enter ATC"
                               value="{{ old('atc', $values['atc']) }}" required>
                    </div>

                    <!-- Port -->
                    <div class="col-md-8 mb-4">
                        <label for="port" class="form-label" style="font-weight: bold;">Port</label>
                    ...
                    <!-- Speed -->
                    <div class="col-md-2 mb-4">
                        <label for="speed" class="form-label" style="font-weight: bold;">Speed</label>
                        <input type="text" id="speed" name="speed" class="form-control" placeholder="Enter speed"
                               value="{{ old('speed', $values['speed']) }}">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        <label for="client_name" class="form-label" style="font-weight: bold;">Client Name</label>
                        <input type="text" id="client_name" name="client_name" class="form-control" placeholder="Enter client name"
                               value="{{ old('client_name', $values['client_name']) }}">
                    </div>

                    <!-- Client Number -->
                    <div class="col-md-4 mb-4">
                        <label for="client_number" class="form-label" style="font-weight: bold;">Client Number</label>
                        <input type="text" id="client_number" name="client_number" class="form-control" placeholder="+998 "
                               value="{{ old('client_number', $values['client_number']) }}">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <!-- Date Connected -->
                    <div class="col-md-4 mb-4">
                        <label for="date_connect" class="form-label" style="font-weight: bold;" >Date Connected</label>
                        <input type="date" id="date_connect" name="date_connect" class="form-control"
                               value="{{ old('date_connect', $values['date_connect']) }}">
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="text" id="location" name="location" class="form-control" placeholder="Enter location"
                               value="{{ old('location', $values['location']) }}">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 mb-4">
                        ...
                        <textarea id="comment" name="comment" rows="3" class="form-control" placeholder="Enter comment">{{ old('comment', $values['comment'] ?? '') }}</textarea>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 mb-1">
                            <label class="form-label" style="font-weight: bold;">AKT Device</label>
                            <div class="image-upload">
                                ...
                                @if(isset($values['images']['image1']))
                                    <img src="http://one_net1.loc{{ $values['images']['image1']['url'] }}" alt="Image 1"
                                         class="preview-image" style=" width:200px; height:120px; object-fit:cover; margin-top: 7px">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 mb-1">
                            <label class="form-label" style="font-weight: bold;">AKT Speed</label>
                            <div class="image-upload">
                                <label for="image2">
                                    <i class="bi bi-cloud-upload fs-2 text-primary"></i>
                                </label>
                                ...
                                @if(isset($values['images']['image2']))
                                    <img src="http://one_net1.loc{{ $values['images']['image2']['url'] }}" alt="Image 2"
                                         class="preview-image" style=" width:200px; height:120px; object-fit:cover; margin-top: 7px">
                                @endif
                            </div>
                        </div>
                        ...
                        <!-- Image Upload Container 3 -->
                            ...
                            <div class="col-md-2 mb-1">
                                <label class="form-label" style="font-weight: bold;">Device</label>
                                <div class="image-upload">
                                    <label for="image3">
                                        <i class="bi bi-cloud-upload fs-2 text-primary"></i>
                                    </label>
                                    ...
                                    @if(isset($values['images']['image3']))
                                    <img src="http://one_net1.loc{{ $values['images']['image3']['url'] }}" alt="Image 3"
                                         class="preview-image" style="width:200px; height:120px; object-fit:cover;margin-top: 7px">
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="col-md-2 mb-1">
                            ...
                            <div class="image-upload">
                                ...
                                @if(isset($values['images']['image4']))
                                    <img src="http://one_net1.loc{{ $values['images']['image4']['url'] }}" alt="Image 4"
                                         class="preview-image" style="width:200px; height:120px; object-fit:cover;margin-top: 7px">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 mb-1">
                            ...
                            <div class="image-upload">
                                ...
                                @if(isset($values['images']['image5']))
                                    <img src="http://one_net1.loc{{ $values['images']['image5']['url'] }}" alt="Image 5"
                                         class="preview-image" style="width:200px; height:120px; object-fit:cover;margin-top: 7px">
                                @endif
                            </div>
                        </div>
                ...
                <div class="text-center mt-5">
                    <button type="submit" class="btn btn-primary btn-lg rounded shadow">Update Host</button>
                </div>
            </form>
        </div>
    </div>
